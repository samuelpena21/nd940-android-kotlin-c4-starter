...
class RemindersLocalRepository(
     ...
     * @return Result the holds a Success with all the reminders or an Error object with the
     * error message
     */
     ...
     * @return Result the holds a Success object with the Reminder or an Error object with the
     * error message
     */
